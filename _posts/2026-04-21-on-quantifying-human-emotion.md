...
Since the 80s, many studies have used this model, and more complex models are either based on this one or can be simplified to it. That's a beautiful thing about this model: it's tried and true. Another beautiful thing about this model is that the two axes of valence and arousal allow us to model emotion as coordinates on a plane, and that's a representation a computer can understand. This is the model I've chosen to power the next step of my work: *with physiological measurements (i.e. heart rate, sweat level, breathing rate, or sleep analysis), how can we measure valence and arousal, so computers to understand human emotions?*

Once computers can understand how we're feeling, they can be better teammates. Say you are working with a robot on a task. Some tasks are assigned to you, while other tasks are assigned to the robot. The robot can understand your emotions to give you tasks that make you happy or calm, while avoiding giving you tasks that make you stressed or defeated. Or, instead, perhaps it does give you tasks which challenge you and make you stressed, but not more than you can handle. Depending on the application, this model of emotion can be flexible, so robots can use the same information but respond in different ways. 
